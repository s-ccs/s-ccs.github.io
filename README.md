...
In general the toc pages (such es Teaching Ressources or Theis Art) are just a hub to link to the content of this group. But of course there should be some content before the grid of links. In each folder that becomes a toc page, you can add a index_content.md file. This file will be ignored by any navigation elements and the contents will be prepended to the links of the toc page.

Furthermore TOC pages now have an image preview on hover. The images for each tile have to be added by hand. Images should have resolution of 400px x 430px. Folder structure is like: `\assets\toc-previews\sub-folder-name\Page-Name.jpg`
